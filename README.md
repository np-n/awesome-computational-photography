...
|   2021   |  arXiv05 | Attention for Image Registration (AiR): an unsupervised Transformer approach | Zihao Wang, Hervé Delingette | [Paper](https://arxiv.org/abs/2105.02282)/[Code](https://gitlab.inria.fr/zihwang/transformer-for-image-registration)                                                                                                              
...
|   2020   |   TIP    | Cross-Weather Image Alignment via Latent Generative Model with Intensity Consistency | Huabing Zhou, Jiayi Ma, et al.                               | [Paper](https://ieeexplore.ieee.org/document/9046236)/Code                                                                                                                                                                        |
|   2020   |   TIP    | Boosting Structure Consistency for Multispectral and Multimodal Image Registration | Si-Yuan Cao, Hui-Liang Shen, Shu-Jie Chen, Chunguang Li      | [Paper](https://ieeexplore.ieee.org/document/9043847)/Code                                                                                                                                                                        |
|   2020   |   TIP    | Local-Adaptive Image Alignment Based on Triangular Facet Approximation | Jing Li, et al.                                              | [Paper](https://ieeexplore.ieee.org/document/8887545)/[Code](https://github.com/gain2217/Triangular_Facet_Approximation)                                                                                                          |
|   2020   |   ECCV   | RANSAC-Flow: Generic Two-stage Image Alignment               |                                                              | [Paper](https://arxiv.org/abs/2004.01526)/[Code](https://github.com/XiSHEN0220/RANSAC-Flow)                                                                                                                                       |
|   2020   |   ECCV   | Aligning Videos in Space and Time                            |                                                              | [Paper](https://arxiv.org/abs/2007.04515)/Code                                                                                                                                                                                    |
|   2020   |   CVPR   | Unsupervised Multi-Modal Image Registration via Geometry Preserving Image-to-Image Translation | Moab Arar, Yiftach Ginger, et al.                            | [Paper](https://openaccess.thecvf.com/content_CVPR_2020/papers/Arar_Unsupervised_Multi-Modal_Image_Registration_via_Geometry_Preserving_Image-to-Image_Translation_CVPR_2020_paper.pdf)/[Code](https://github.com/moabarar/nemar) |
|   2019   |   TIP    | Online Subspace Learning from Gradient Orientations for Robust Image Alignment | Qingqing Zheng, Yi Wang, Pheng Ann Heng                      | [Paper](https://ieeexplore.ieee.org/document/8630746)/Code                                                                                                                                                                        |
...
|   2018   |   PAMI   | Hierarchical Sparse Representation for Robust Image Registration | Yeqing Li, et al.                                            | [Paper](https://cchen156.github.io/paper/15CVPR_DSR.pdf)/Code                                                                                                                                                                     |
...
|   2018   |   ECCV   | Multimodal image alignment through a multiscale chain of neural networks with application to remote sensing |                                                              | [Paper](https://openaccess.thecvf.com/content_ECCV_2018/papers/Armand_Zampieri_Multimodal_image_alignment_ECCV_2018_paper.pdf)/Code                                                                                               |
